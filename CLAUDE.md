...
### 進捗
- **未完了 12 / 90（約 87%）**
- 直近成果（2026-05-23）：**`012-0008` 全件クリア（7205/7206 OTA PASS）**。S3 presigned URL 経由クラウド OTA・dual-partition 動作確認完了。
...
| **011** 章 | 0 件 | 完了 |
| **012** 章 | 1 件 | `012-0009` まとめ・文書整合（進行中） |
...
- 2026-05-23: `012-0008` 全件クリア（7205/7206 OTA PASS）に伴い「§2 現在地」「§3 次の本線」を更新。進捗 12/90（約 87%）。主要バグ修正：IoT Policy `esp32lab/*` 拡張 / `ota.cpp` cloud mode AmazonRootCA1.pem 切替。Git タグ候補 `v1.1.0-cloud-ota`（012-0009 完了後付与）を記載。
